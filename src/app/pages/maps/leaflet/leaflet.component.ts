  ...
  */
   ...
   */
   markers = {
    ...
    polygon([[51.509, -0.08], [51.503, -0.06], [51.51, -0.047],], { color: "#485388", fillColor: "#485388" }),
    marker([51.5, -0.09])
  ];
  ...
  popupLayers = [
    ...
    polygon([[51.509, -0.08], [51.503, -0.06], [51.51, -0.047],], { color: "#485388", fillColor: "#485388" }).bindPopup("I am a polygon."),
