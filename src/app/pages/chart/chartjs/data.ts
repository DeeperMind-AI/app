    ...
    datasets: [
        {
            ...
            pointBorderColor: '#485388',
            pointBackgroundColor: '#fff',
            pointBorderWidth: 1,
            pointHoverRadius: 5,
            pointHoverBackgroundColor: '#485388',
    ...
    datasets: [
        {
            ...
            hoverBackgroundColor: ['#485388', '#ebeff2'],
            hoverBorderColor: '#fff',
        }],
    options: {
        maintainAspectRatio: false,
...
const radarChart: ChartType = {
    ...
    datasets: [
        ...
        },
        {
            ...
            backgroundColor: 'rgba(85, 110, 230, 0.2)',
            borderColor: '#485388',
            pointBackgroundColor: '#485388',
            pointBorderColor: '#fff',
            pointHoverBackgroundColor: '#fff',
            pointHoverBorderColor: '#485388',
...
const polarChart: ChartType = {
    ...
    datasets: [
        {
            data: [11, 16, 7, 18],
            backgroundColor: ['#f46a6a', '#34c38f', '#f1b44c', '#485388'],
