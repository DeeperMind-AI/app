...
const simplePieChart: ChartType = {
    ...
    colors: ['#34c38f', '#485388', '#f46a6a', '#50a5f1', '#f1b44c'],
    legend: {
        show: true,
        position: 'bottom',
...
const basicRadialBarChart: ChartType = {
    ...
    colors: ['#485388', '#34c38f', '#f46a6a', '#f1b44c'],
    series: [44, 55, 67, 83],
