...
export class TopbarComponent implements OnInit {
  ...
  */
  ...
  listLang = [
    { text: 'English', flag: (this.configService.isPoc?'assets/images/flags/en.jpg':'assets/images/flags/us.jpg'), lang: 'en' },
  ...
  changeColorMode() {    
    this.mainColorMode = (this.mainColorMode=="light"?"dark":"light");
    this.eventService.broadcast('changeMode', this.mainColorMode);
